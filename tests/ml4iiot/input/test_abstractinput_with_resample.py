import unittest
from tests.ml4iiot.input.test_abstractinput_without_resample import TestInput


class TestAbstractInputWithResample(unittest.TestCase):

    def create_test_input(self, window_size, stride_size, resample, test_data):
        config = {
